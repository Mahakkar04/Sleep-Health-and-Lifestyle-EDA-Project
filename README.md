# Sleep-Health-and-Lifestyle-EDA-Project
This project presents a comprehensive Exploratory Data Analysis (EDA) of a Sleep Health and Lifestyle dataset to understand how lifestyle habits, demographic factors, and health indicators influence sleep quality and overall well-being.The analysis focuses on discovering meaningful patterns and relationships using data cleaning, statistical summaries, and informative visualizations.
...
- Percentage of Individuals by Sleep Disorder Category
- alcohol consumption affect average sleep score
- Influence of Screen Time on Sleep Duration
- Correlation Among Health Metrics (Heart Rate, Resting HR, Oxygen Saturation, and Sleep Score)
